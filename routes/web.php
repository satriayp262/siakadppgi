...
Route::middleware(['auth', CheckRole::class . ':mahasiswa'])->prefix('mahasiswa')->group(function () {
    ...
    Route::get('/emonev/dosen/{nama_semester}', App\Livewire\Mahasiswa\Emonev\Index::class)->name('mahasiswa.emonev');
    Route::get('/jadwal', App\Livewire\Mahasiswa\Jadwal\Index::class)->name('mahasiswa.jadwal');
    Route::get('/show/{id_mata_kuliah}', App\Livewire\Mahasiswa\Emonev\Show::class)->name('emonev.detail');
