...
<div class="bg-white shadow-lg p-4 mt-4 mb-4 rounded-lg size-fit justify-center mx-auto">
    <div class="flex flex-col items-center">
        <div class="border-b pb-4">
            <h1 class="text-3xl font-bold text-gray-800 text-center">Konfirmasi Tagihan</h1>
            <p class="text-center text-gray-600 mt-2 text-sm">Harap periksa detail tagihan sebelum melanjutkan
                pembayaran.</p>
        </div>
        ...
        <form wire:submit="save">
            ...
            <div class="flex justify-center p-4 bg-gray-200 rounded-b-lg">
                <a href="{{ route('staff.tagihan') }}"
                    class="px-4 py-2 font-bold text-white bg-red-500 rounded hover:bg-red-700">Close</a>
                <button type="submit"
