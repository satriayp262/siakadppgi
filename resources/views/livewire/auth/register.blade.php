    ...
    <div class="py-8 px-4 w-[400px] space-y-8 bg-white shadow-md rounded-lg">
        ...
        <form wire:submit="save" class="h-full">
            <div class="space-y-6">
                ...
                <div>
                    <button type="submit"
                        class="flex w-full justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-600">Register</button>
                </div>
            </div>
        </form>
