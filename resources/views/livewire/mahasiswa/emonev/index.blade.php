        ...
        <div class="bg-white shadow-lg p-6 rounded-lg max-w-full text-center">
            ...
            @else
                ...
                @if (!$isPeriode1 && !$isPeriode2)
                    ...
                    <p>Periode 1: {{ \Carbon\Carbon::parse($periode1->tanggal_mulai)->translatedFormat('d M Y') }} -
                        {{ \Carbon\Carbon::parse($periode1->tanggal_selesai)->translatedFormat('d M Y') }} : 23.59</p>
                    <p>Periode 2: {{ \Carbon\Carbon::parse($periode2->tanggal_mulai)->translatedFormat('d M Y') }} -
                        {{ \Carbon\Carbon::parse($periode2->tanggal_selesai)->translatedFormat('d M Y') }} : 23.59</p>
                @else
                    {{-- Judul --}}
