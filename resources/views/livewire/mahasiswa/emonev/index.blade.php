    ...
    <div class="flex flex-col justify-between mx-4 mt-4 mb-6">
        ...
        @else
            @php
                ...
                $isPeriode1 = $now >= $periode1->tanggal_mulai && $now <= $periode1->tanggal_selesai;
                $isPeriode2 = $now >= $periode2->tanggal_mulai && $now <= $periode2->tanggal_selesai;
            @endphp

            @if (!$isPeriode1 && !$isPeriode2)
                <div class="bg-red-100 text-red-800 px-4 py-2 rounded-lg text-center">
                    <p class="font-semibold">e-Monev tidak dapat diakses saat ini.</p>
                                    ...
                                    <td class="px-2 py-2 text-center">
                                        ...
                                        @if ($emonev?->sesi == null)
                                            <span
                                                ...
                                                Mengisi</span>
                                        @elseif ($emonev->sesi == 1)
                                            <span
                                                class="px-2 py-1 bg-green-200 text-green-800 rounded-full text-xs font-semibold">Sudah
                                                Mengisi</span>
                                        @else
                                            <span
