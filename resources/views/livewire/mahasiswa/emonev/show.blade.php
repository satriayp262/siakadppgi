...
<div class="mx-5">
    <div class="flex flex-col justify-between mx-4 mt-4 mb-6">
        ...
        @if ($e->sesi == null || $e->sesi == 1)
            ...
            <!-- FORM END -->
        @else
            <div class="bg-white shadow-lg p-6 mt-6 rounded-lg text-center">
                <h2 class="text-purple2 text-2xl font-extrabold mb-2">Emonev Sudah Diisi</h2>
            </div>
        @endif
    </div>
</div>
