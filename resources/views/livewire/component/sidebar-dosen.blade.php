            ...
            <ul class="relative sticky space-y-2 font-medium top-20">
                <li>
                    <a href="{{ route('dosen.dashboard') }}"
                        ...
                        {{ request()->routeIs('dosen.dashboard') ? ' text-white' : 'text-gray-500 hover:bg-gray-500 hover:text-gray-100' }}">
                        <svg class="flex-shrink-0 w-5 h-5 transition duration-75 group-hover:text-white {{ request()->routeIs('dosen.dashboard') ? 'text-white' : 'text-gray-500' }}"
