    ...
    <div x-data="{ load: false }" x-show="isOpen && load" x-init="load = true" wire:init="" x-cloak
        ...
        <div class="w-1/2 bg-white rounded-lg shadow-lg">
            ...
            <div class="flex items-center justify-between p-4 bg-gray-200 rounded-t-lg">
                <h3 class="text-xl font-semibold">Edit Data Ruangan</h3>
                <div @click="isOpen=false" wire:click="clear({{ $id_ruangan }})" class="px-3 rounded-sm shadow hover:bg-red-500">
            ...
            <div class="p-4 text-left"> <!-- Added text-left here -->
                <div class="p-4 max-h-[500px] overflow-y-auto">
                    <form wire:submit="update">
                        <input type="text" hidden wire:model="id_ruangan">
                        <div class="mb-4">
                        ...
                        <div class="flex justify-end p-4 bg-gray-200 rounded-b-lg">
                            <button type="button" wire:click="clear({{ $id_ruangan }})" @click="isOpen = false"
