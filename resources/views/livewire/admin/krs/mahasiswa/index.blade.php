    ...
    @if ($mahasiswa)
        ...
        <div class="">
            @foreach ($semester as $x)
                ...
                @endphp
                @if (!((count($krs) == 0) && ($mahasiswa->getSemester($x->id_semester) > 6)))
                                ...
                                <table class="min-w-full border-collapse table-auto md:text-[16px] text-[10px]">
                                    <thead>
                                        <tr class="items-center w-full text-white align-middle bg-customPurple">
                                            ...
                                            <th class="px-2 py-1 sm:px-4 sm:py-2 text-center border">SKS Praktek
                                                Lapangan
                                            </th>
                                            <th class="px-2 py-1 sm:px-4 sm:py-2 text-center border">SKS Simulasi</th>
                                            <th class="px-2 py-1 sm:px-4 sm:py-2 text-center border">Jenis Mata Kuliah
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
