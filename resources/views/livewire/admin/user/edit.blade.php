                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePasswordVisibility('confirmPassword', this)"
                                    ...
                                    <svg id="eyeIcon" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <!-- Default closed eye icon (password hidden) -->
...
<script>
    let passwordVisible = false; // Track visibility of password
    ...
    function togglePasswordVisibility(id, button) {
        ...
        if (passwordVisible) {
            ...
            // Update SVG to closed eye icon (password hidden)
            eyeIcon.innerHTML = `
            ...
            // Update SVG to open eye icon (password visible)
            eyeIcon.innerHTML = `
