    ...
    <div class="flex justify-between mb-4 mt-4 items-center mx-4">
        <div x-data="{ isOpen: false, load: false }" @modal-closed.window="isOpen = false">
            ...
            <button @click="isOpen=true; load=true"
                ...
                <svg class="mx-2 md:w-8 md:h-8 w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="26" height="26"
                    viewBox="0 0 48 48">
                            ...
                            <form wire:submit.prevent="exportExcel">
                                ...
                                <div class="mb-4">
                                    <div class="flex flex-col">
                                        <label for="kode_prodi" class="block text-sm font-medium text-gray-700">Pilih
                                            Semester Yang
