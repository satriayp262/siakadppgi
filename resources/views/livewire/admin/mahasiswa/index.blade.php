        ...
        <div class="flex justify-between mt-2">
            <div class="flex space-x-2">
                ...
                <div x-data="{ isOpen: false, load: false }" @modal-closed.window="isOpen = false">
                    ...
                    <div x-show="isOpen && load" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-gray-600 bg-opacity-75">
                                ...
                                <div class="p-4 max-h-[500px] overflow-y-auto">
                                    <form wire:submit.prevent="import">
                                        ...
                                        <div class="mb-4">
                                            <div class="flex flex-col">
                                                ...
                                                <button wire:click="downloadTemplate"
                                                    ...
                                                    <svg class="w-6 h-6 text-gray-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                                        <path fill="currentColor" d="M9 2.221V7H4.221a2 2 0 0 1 .365-.5L8.5 2.586A2 2 0 0 1 9 2.22ZM11 2v5a2 2 0 0 1-2 2H4v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2h-7Z" clip-rule="evenodd"/>
                                                    </svg>
                                                    <span class="text-left flex-grow px-2 text-black-500 font-medium">Template_Mahasiswa.xlsx</span>
                                        ...
                                        <div class="flex justify-end p-4 bg-gray-200 rounded-b-lg">
                                            <button type="button" @click="isOpen = false" class="px-4 py-2 font-bold text-white bg-red-500 rounded hover:bg-red-700">Close</button>
                                            <button type="submit" class="px-4 py-2 ml-2 font-bold text-white bg-green-500 rounded hover:bg-green-700">Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
