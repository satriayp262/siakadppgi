    ...
    <div class="flex flex-col justify-between mx-4 mt-2">
        <div class="flex justify-between mt-2">
            ...
            <div x-data="{ showFilter: false }" class="relative flex items-center">
                ...
                <div @mouseenter="showFilter = true" class="relative">
                    <img src="{{ asset('img/sort.png') }}" alt="Filter Search"
                        ...
                        <ul class="space-y-2">
                            <li>
                                <label class="inline-flex items-center">
                                    ...
                                    <select name="filter_angkatan" id="filter_angkatan"
                                        wire:model.live="filter_angkatan"
