                ...
                <div class="p-4 text-left">
                    <div class="p-4 max-h-[500px] overflow-y-auto">
                        <form wire:submit.prevent="update">
                            ...
                            <!-- Nama Dosen -->
                            <div class="mb-4">
                                <label for="nama_dosen_{{ $id_dosen }}"
                                    class="block text-sm font-medium text-gray-700">Nama Dosen</label>
                                <input type="text" id="nama_dosen_{{ $id_dosen }}" wire:model="nama_dosen"
                                    name="nama_dosen"
                            ...
                            <!-- Jenis Kelamin -->
                            <div class="mb-4">
                                <label for="jenis_kelamin_{{ $id_dosen }}"
                                    class="block text-sm font-medium text-gray-700">Jenis Kelamin</label>
                                <select id="jenis_kelamin_{{ $id_dosen }}" wire:model="jenis_kelamin"
                                    name="jenis_kelamin"
                            ...
                            <!-- Jabatan Fungsional -->
                            <div class="mb-4">
                                <label for="jabatan_fungsional_{{ $id_dosen }}"
                                    class="block text-sm font-medium text-gray-700">Jabatan Fungsional</label>
                                <input type="text" id="jabatan_fungsional_{{ $id_dosen }}"
                                    wire:model="jabatan_fungsional" name="jabatan_fungsional"
                                    class="block w-full px-2 py-1 mt-1 bg-gray-200 border-gray-700 rounded-md shadow-2xl focus:border-indigo-500 sm:text-sm">
                            ...
                            <!-- Kepangkatan -->
                            <div class="mb-4">
                                <label for="kepangkatan_{{ $id_dosen }}"
                                    class="block text-sm font-medium text-gray-700">Kepangkatan</label>
                                <input type="text" id="kepangkatan_{{ $id_dosen }}" wire:model="kepangkatan"
                                    name="kepangkatan"
                                    class="block w-full px-2 py-1 mt-1 bg-gray-200 border-gray-700 rounded-md shadow-2xl focus:border-indigo-500 sm:text-sm">
                                @error('kepangkatan')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                            ...
                            <!-- Nama Prodi -->
                            <div class="mb-4">
                                <label for="kode_prodi_{{ $id_dosen }}"
                                    class="block text-sm font-medium text-gray-700">Nama Prodi</label>
