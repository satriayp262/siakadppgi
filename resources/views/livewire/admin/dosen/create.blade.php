    ...
    <div x-show="isOpen && load" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-gray-600 bg-opacity-75">
        <div class="w-1/2 bg-white rounded-lg shadow-lg">
            ...
            <div class="flex items-center justify-between p-4 bg-gray-200 rounded-t-lg">
                ...
                <button @click="isOpen = false" class="text-gray-900 px-3 py-1 hover:bg-red-500 rounded-sm">&times;</button>
            </div>
                ...
                <form wire:submit.prevent="save">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="nidn" wire:model="nidn" name="nidn"
                            class="block w-full px-2 py-1 mt-1 bg-gray-200 border border-gray-400 rounded-md shadow-sm focus:border-indigo-500 sm:text-sm">
                        @error('nidn') <span class="text-sm text-red-500">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="jabatan_fungsional" wire:model="jabatan_fungsional"
                            class="block w-full px-2 py-1 mt-1 bg-gray-200 border border-gray-400 rounded-md shadow-sm focus:border-indigo-500 sm:text-sm">
                        @error('jabatan_fungsional') <span class="text-sm text-red-500">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="kepangkatan" wire:model="kepangkatan"
                            class="block w-full px-2 py-1 mt-1 bg-gray-200 border border-gray-400 rounded-md shadow-sm focus:border-indigo-500 sm:text-sm">
                        @error('kepangkatan') <span class="text-sm text-red-500">{{ $message }}</span> @enderror
                    </div>
