            ...
            <div class="p-4">
                <div class="p-4 max-h-[500px] overflow-y-auto">
                    <form wire:submit="save">
                        ...
                        <div class="mb-4">
                            <label for="sks_praktek_lapangan" class="block text-sm font-medium text-gray-700">SKS Praktek Lapangan</label>
                            <input type="text" id="sks_praktek_lapangan" wire:model="sks_praktek_lapangan" name="sks_praktek_lapangan"
                                class="block w-full px-2 py-1 mt-1 bg-gray-200 border-gray-700 rounded-md shadow-2xl focus:border-indigo-500 sm:text-sm">
                        ...
                        <div class="mb-4">
                            <label for="sks_simulasi" class="block text-sm font-medium text-gray-700">SKS Simulasi</label>
                        ...
                        <div class="mb-4">
                            <label for="tgl_akhir_efektif" class="block text-sm font-medium text-gray-700">Tanggal Akhir Efektif</label>
                            <input type="date" id="tgl_akhir_efektif" wire:model="tgl_akhir_efektif" name="tgl_akhir_efektif"
                                class="block w-full px-2 py-1 mt-1 bg-gray-200 border-gray-700 rounded-md shadow-2xl focus:border-indigo-500 sm:text-sm">
