<div class="flex items-center justify-center gap-x-1">
    ...
    <button wire:key="delete-{{ $row->id_berita_acara }}" onclick="confirmDelete('{{ $row->id_berita_acara }}')"
        class="w-8 h-8 flex items-center justify-center bg-red-500 text-white rounded hover:bg-red-700">
        <svg class="w-4 h-4" fill="none" viewBox="0 0 22 22" stroke="currentColor">
