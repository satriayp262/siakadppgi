<div x-data="{ isOpen: false }" @modal-closed.window="isOpen = false">
    <button @click="isOpen=true"
        class="inline-block px-2 sm:px-4 py-2 sm:py-2 text-white bg-blue-500 rounded hover:bg-blue-700">
        <svg class="w-4 sm:w-6 h-4 sm:h-6 text-gray-800 dark:text-white" aria-hidden="true"
